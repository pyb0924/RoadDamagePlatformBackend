...
def search_event(type: int = None, min_longitude: float = None, max_longitude: float = None,
...
def update_event(event_id: str, status: int, user: str, notes: str):
    try:
...
def new_event(event_id: str, userlist: List[str]):
    try:
